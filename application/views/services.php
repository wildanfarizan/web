<html lang="en"><head>
  ...
  <style type="text/css">.scrollax-performance, .scrollax-performance *, .scrollax-performance *:before, .scrollax-performance *:after { pointer-events: none !important; -webkit-animation-play-state: paused !important; animation-play-state: paused !important; };</style><script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/57/0/intl/id_ALL/common.js"></script><script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/57/0/intl/id_ALL/util.js"></script></head>
  <body data-aos-easing="slide" data-aos-duration="800" data-aos-delay="0">

	<div id="colorlib-page">
		<a href="#" class="js-colorlib-nav-toggle colorlib-nav-toggle"><i></i></a>
		<aside id="colorlib-aside" role="complementary" class="js-fullheight text-center" style="height: 617px;">
			<h1 id="colorlib-logo"><a href="index.html"><span class="img" style="background-image: url(<?php echo base_url().'assets/images/image_11.jpg'?>);"></span>Louie Smith</a></h1>
		...
		<div id="colorlib-main">
	      ...
	      <div class="container">
	        <div class="row">
	          ...
	          <div class="col-md-4 d-flex align-sel Searchf-stretch ftco-animate fadeInUp ftco-animated">
	            <div class="media block-6 services py-4 d-block">
	              <div class="d-flex justify-content-start">
	              	<div class="icon d-flex align-items-center justify-content-center">
	          ...
	          <div class="col-md">
	            <div class="ftco-footer-widget mb-4 ml-md-4">
	              ...
	              <ul class="list-unstyled photo">
	                <li><a href="#" class="img" style="background-image: url(<?php echo base_url().'assets/images/image_1.jpg'?>);"></a></li>
	                <li><a href="#" class="img" style="background-image: url(<?php echo base_url().'assets/images/image_2.jpg'?>);"></a></li>
	                <li><a href="#" class="img" style="background-image: url(<?php echo base_url().'assets/images/image_3.jpg'?>);"></a></li>
	                <li><a href="#" class="img" style="background-image: url(<?php echo base_url().'assets/images/image_4.jpg'?>);"></a></li>
	                <li><a href="#" class="img" style="background-image: url(<?php echo base_url().'assets/images/image_5.jpg'?>);"></a></li>
	                <li><a href="#" class="img" style="background-image: url(<?php echo base_url().'assets/images/image_6.jpg'?>);"></a></li>
	              </ul>
	            </div>
	          </div>
	          <div class="col-md">
